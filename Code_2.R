...
pdf("Figure3B.pdf",width=8.0,height=10.0)
print(gmresult[["plt"]]) 
dev.off()
...
pdf("Figure3C.pdf",width=8.0,height=10.0)
print(wmresult[["plt"]]) 
dev.off()
...
pdf("Figure4A.pdf",width=8.0,height=10.0)
print(hpresult[["plt"]]) 
dev.off()
...
pdf("Figure4B.pdf",width=8.0,height=10.0)
...
pdf("Figure5B.pdf",width=10.0,height=5.5)
...
pdf("Figure5C.pdf",width=10.0,height=5.5)
...
pdf("Figure5D.pdf",width=10.0,height=5.5)
...
pdf("Figure5E.pdf",width=10.0,height=5.5)
...
slm_hp <- hpresult[["slm"]]
pdf("Figure8Atop.pdf",width=12.0,height=5.5)
print(hpresult[["plt"]]) 
dev.off()
...
slm_pr <- prresult[["slm"]]
pdf("Figure8Abottom.pdf",width=12.0,height=5.5)
print(prresult[["plt"]]) 
dev.off()
...
pdf("Figure6B.pdf",width=10.0,height=5.5)
print(cplt) 
dev.off()
...
pdf("Figure7B.pdf",width=10.0,height=5.5)
print(cplt) 
dev.off()
...
pdf("Figure8B.pdf",width=10.0,height=5.5)
print(cplt) 
dev.off()
...
## SAVE TO PDF ##
pdf("Figure2.pdf", width = 10.0, height = 5.5)
print(cplt)
dev.off()
